...
quellen = []
with open("Thesen/IsraelGazaVerlauf/Quellen.csv", 'r', newline='', encoding='utf-8') as liste:
...
# DataFrame speichern
data.to_csv("Thesen/IsraelGazaVerlauf/Kommentare.csv", index=False)
