...
quellen = []
with open("Thesen/EMSpiele/Quellen.csv", 'r', newline='', encoding='utf-8') as liste:
...
data.to_csv("Thesen/EMSpiele/KommentareRaw.csv", index=False)
...
data.to_csv("Thesen/EMSpiele/KommentareTrans.csv", index=False)
...
data.to_csv("Thesen/EMSpiele/Kommentare.csv", index=False)
